...
public class EditDistance {
     ...
     */
    public static int stringDistance(String x, String y) {
     ...
     * @param <T> type of arrays.
     */
    private static <T> int distance(ArrayWrapper<T> x, ArrayWrapper<T> y) {
    ...
    protected interface ArrayWrapper<T> {
         ...
         * otherwise.
         */
        boolean equals(ArrayWrapper<T> other, int posX, int posY);
    }
    ...
    protected static class StringArrayWrapper implements ArrayWrapper<String> {
         ...
         */
        public StringArrayWrapper(String object) {
            mObject = object;
        }
         ...
         */
        @Override
        public boolean equals(ArrayWrapper<String> other, int posX,
                              int posY) {
            ...
            String otherObject = ((StringArrayWrapper)other).mObject;
    ...
    protected static class GenericArrayWrapper<T> implements ArrayWrapper<T[]> {
         ...
         */		
        @Override
        public boolean equals(ArrayWrapper<T[]> other, int posX, int posY) {
            if (!(other instanceof GenericArrayWrapper)) {
                return false;
            }

            T[] otherObject = ((GenericArrayWrapper<T>)other).mObject;
